...
import { formatCurrency, formatPercentage, formatMonth, getCurrentMonth, MIN_SAVINGS_RATE_PERCENT } from "@/lib/utils";
...
export function InsightsContent({ data, currency, email }: InsightsContentProps) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-6 space-y-6">
        <div className="space-y-2">
          <h1 className="text-2xl font-bold">Insights & Statistics</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <IncomeSavingsLineChart data={data.monthlyTrends} currency={currency} />
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg flex items-center gap-2">
                ...
                <Badge variant="secondary">{data.monthsWithLowSavings.length}</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
